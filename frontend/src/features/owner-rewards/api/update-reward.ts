...
export const updateReward = ({
  id,
  ...data
}: UpdateRewardDTO): Promise<OwnerReward> => {
  return api.patch(`/rewards/${id}`, data);
};

type UseUpdateRewardOptions = {
  mutationConfig?: MutationConfig<typeof updateReward>;
};

export const useUpdateReward = ({
  mutationConfig,
}: UseUpdateRewardOptions = {}) => {
